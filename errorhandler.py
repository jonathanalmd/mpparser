    ...
    if value == "(":
        ...
        if run_mode == "strips" and value.upper() == "PRECONDITIONS":
            ...
            if value[0] == "@":
                ...
                print("Syntax error in ':predicates' definition (in/before line %d)"%(plex.lexer.lineno))
                print("\tPredicate name(s) repetition")
            elif value[0] == ">":
                print("Syntax error in action definition")
            ...
            if value[0] == "?":
                ...
                print("Syntax error in problem domain definition in line %d"%(plex.lexer.lineno))
